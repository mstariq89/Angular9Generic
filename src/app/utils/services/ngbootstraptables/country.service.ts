...
import { Country } from '../../models/ngbootstraptables/country';
import { SortColumn, SortDirection } from '../../directives/ngbootstraptables/sortable.directive';
import { COUNTRIES } from '../../models/ngbootstraptables/countries';
...
function matches(country: Country, term: string, pipe: PipeTransform) {
  ...
  //   || country.emailid.toLowerCase().includes(term.toLowerCase())
