...
import { SortColumn, SortDirection } from '../../directives/ngbootstraptables/sortable.directive';
import { Customer } from '../../models/ngbootstraptables/customer';
import { CUSTOMERS } from '../../models/ngbootstraptables/customers';
...
function matches(customer: Customer, term: string, pipe: PipeTransform) {
  return customer.customerName.toLowerCase().includes(term.toLowerCase())
    || customer.country.toLowerCase().includes(term.toLowerCase())
    || customer.emailid.toLowerCase().includes(term.toLowerCase())
